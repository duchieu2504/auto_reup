  ...
  return (
    <div className="space-y-8">
          ...
          <AnimatePresence>
            {isCrawling && (
              <motion.div
                ...
                exit={{ opacity: 0, y: 10 }}
                className="bg-bg-secondary/30 p-4 rounded-xl border border-border-subtle/50 flex flex-col gap-2.5"
              >
                <div className="flex justify-between items-center">
                  <span className="text-xs font-bold text-text-secondary uppercase tracking-wider">Tiến trình cào</span>
      ...
      <div className="lg:col-span-3 glass-panel p-6 rounded-2xl border border-white/5 relative overflow-hidden flex flex-col justify-between gap-5 min-h-0">
        ...
        <div className="relative rounded-xl overflow-hidden border border-border-subtle shadow-2xl flex flex-col">
          ...
          <div
            ref={logContainerRef}
            className="bg-[#04060a] p-6 font-mono text-[13px] h-[250px] lg:h-[280px] overflow-y-auto leading-relaxed shadow-inner text-neon-cyan/90 selection:bg-neon-purple/20 selection:text-white"
          >
            {logs.length === 0 ? (
